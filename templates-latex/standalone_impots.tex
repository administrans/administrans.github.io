...
\newcommand{\ProcurantImpots}{ {{- cleaned_data["impots"] -}} }
\newcommand{\ProcurantFiscal}{ {{- cleaned_data["fiscal"] -}} }
...
\newcommand{\Civilite}{
    ...
    Pour toutes ces raisons, je vous demande de mettre \`{a} jour, dans les plus brefs d\'{e}lais, mon pr\'{e}nom et ma civilit\'{e} dans vos registres, et de me tenir \if\ProcurantGender0 inform\'{e}e \else inform\'{e} \fi par retour de courrier \'{e}lectronique de la bonne prise en compte de ces informations.
}
...
%-% \`{À} remplacer par votre lettre de motivation
    Je suis \ProcurantFullId et j'ai r\'{e}cemment obtenu mon changement de pr\'{e}nom à l'\'{E}tat-Civil et je souhaite effectuer les d\'{e}marches de changement de pr\'{e}nom et de civilit\'{e} dans les registres du Service des Impôts des Particuliers de \ProcurantImpots.
