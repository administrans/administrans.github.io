site_trans_cec.forms = (function(){
        ...
        fieldsets: [
          {
            ...
            fields: [
              ...
              { 'type': "select", 'id': "procurantgender", 'label': "Accord de la personne", 'choices': [[0,"féminin"], [2,"neutre"], [1,"masculin"]] },
          ...
          },
          {
            ...
            fields: [
              ...
              { 'type': "select", 'id': "persongender", 'label': "Accord de la personne", 'choices': [[0,"féminin"], [2,"neutre"], [1,"masculin"]] },
            ]
          }
        ]
      }
  ...
  var procurant_identity_fieldset = {
    ...
    fields:[
      ...
      { 'type': "select", 'id': "procurantgender", 'label': "Accord", 'choices': [[0,"féminin"], [2,"neutre"], [1,"masculin"]] },
  ...
  var mkforms = (base_fieldsets, procuration_or_lettre, prefix) =>
    [
      { id: "cpam",
        ...
        pagesubtitle:"Génération de la "+procuration_or_lettre,
  ...
  var standalone_identity_fieldset = {
    ...
    fields:[
      ...
      { 'type': "select", 'id': "gender", 'label': "Accord de la personne", 'choices': [[0,"féminin"], [2,"neutre"], [1,"masculin"]] },
