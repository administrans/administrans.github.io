...
\newcommand{\ProcurantEntreprise}{ {{- form.cleaned_data["entreprise"] -}} }
\newcommand{\ProcurantContrat}{ {{- form.cleaned_data["contrat"] -}} }
...
%-% \`{À} remplacer par votre lettre de motivation
    Je suis \ProcurantFullId et j'ai r\'{e}cemment obtenu mon changement de pr\'{e}nom à l'\'{E}tat-Civil et le souhaite effectuer les d\'{e}marches de changement de pr\'{e}nom et de civilit\'{e} dans les registres du service client de \ProcurantEntreprise.

    \medskip

    Je suis \if\ProcurantGender0 connue \else connu \fi de vos services sous le nom de \ProcurantOldId et je dispose d'un contrat chez vous (\ProcurantContrat).
