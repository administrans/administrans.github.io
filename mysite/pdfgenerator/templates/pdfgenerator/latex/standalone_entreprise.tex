...
%-% \`{À} remplacer par votre lettre de motivation
    Je suis \ProcurantFullId et j'ai r\'{e}cemment obtenu mon changement de pr\'{e}nom à l'\'{E}tat-Civil et je souhaite effectuer les d\'{e}marches de changement de pr\'{e}nom et de civilit\'{e} dans les registres du service client de \ProcurantEntreprise.
