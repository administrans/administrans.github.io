...
\newcommand{\Civilite}{
    ...
    Pour toutes ces raisons, je vous demande de mettre \`{a} jour, dans les plus brefs d\'{e}lais, le pr\'{e}nom et la civilit\'{e} de \ProcurantId {} dans vos registres, et de me tenir \if\ProcurantGender0 inform\'{e}e \else inform\'{e} \fi par retour de courrier \'{e}lectronique de la bonne prise en compte de ces informations.
}
