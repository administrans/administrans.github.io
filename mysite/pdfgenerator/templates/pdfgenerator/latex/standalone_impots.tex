...
\newcommand{\Civilite}{
    ...
    Pour toutes ces raisons, je vous demande de mettre \`{a} jour, dans les plus brefs d\'{e}lais, mon pr\'{e}nom et ma civilit\'{e} dans vos registres, et de me tenir \if\ProcurantGender0 inform\'{e} \else inform\'{e}e \fi par retour de courrier \'{e}lectronique de la bonne prise en compte de ces informations.
}
