...
% la procuration
%\newcommand{\ProcurantSecu}{ {{- form.cleaned_data["ss"] -}} }
...
%-% \`{À} remplacer par votre lettre de motivation
    Je suis \ProcurantFullId et j'ai r\'{e}cemment obtenu mon changement de pr\'{e}nom à l'\'{E}tat-Civil et le souhaite effectuer les d\'{e}marches de changement de pr\'{e}nom et de civilit\'{e} dans les registres du service scolarit\'{e} de \ProcurantEcole.
    ...
    Enfin, je vous prie de bien vouloir m'indiquer quelle proc\'{e}dure je dois effectuer afin d'obtenir une version \'{a} jour, en terme de pr\'{e}nom et de civilit\'{e}, de mes dipl\^{o}mes.
