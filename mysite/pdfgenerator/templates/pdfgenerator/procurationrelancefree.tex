...
%-% \`{\`{a}} remplacer par votre lettre de motivation
    Je suis \if\PersonGender0 mandat\'{e}e \else mandat\'{e} \fi par \ProcurantFullId qui a r\'{e}cemment obtenu son changement de pr\'{e}nom \`{a} l'\'{E}tat-Civil afin d'effectuer les d\'{e}marches de changement de pr\'{e}nom et de civilit\'{e} dans les registres du service client de Free.
    ...
    De plus, je vous demandais de bien vouloir changer sa civilit\'{e} de \if\ProcurantGender0 \og Monsieur \fg{} \`{a} \og Madame \fg{} \else \og Madame \fg{} \`{a} \og Monsieur \fg{} \fi dans vos registres, et ce pr\'{e}alablement \`{a} toute d\'{e}cision de changement de mention de sexe \`{a} l'\'{E}tat-Civil, puisqu'il s'agit d'une personne transgenre.
