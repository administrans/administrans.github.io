...
\newcommand{\ProcurantImpots}{ {{- form.cleaned_data["procurantimpots"] -}} }

% Mettre ici le num\'{e}ro fiscal de la personne faisant la procuration
\newcommand{\ProcurantFiscal}{ {{- form.cleaned_data["procurantfiscal"] -}} }
...
%\newcommand{\ProcurantBanque}{ {{- form.cleaned_data["procurantbanque"] -}} }

% Mettre ici le nom de l'entreprise \`{a} laquelle la personne faisant
% la procuration veut faire un changement
%\newcommand{\ProcurantEntreprise}{ {{- form.cleaned_data["procurantentreprise"] -}} }

% Mettre ici le num\'{e}ro de contrat de l'entreprise cit\'{e}e au dessus
%\newcommand{\ProcurantContrat}{ {{- form.cleaned_data["procurantcontrat"] -}} }
...
%-% \`{À} remplacer par votre lettre de motivation
    Je suis \if\PersonGender0 mandat\'{e}e \else mandat\'{e} \fi par \ProcurantFullId qui a r\'{e}cemment obtenu son changement de pr\'{e}nom à l'\'{E}tat-Civil afin d'effectuer les d\'{e}marches de changement de pr\'{e}nom et de civilit\'{e} dans les registres du Service des Imp\^{o}ts des Particuliers de \ProcurantImpots.
