...
%-% \`{\`{a}} remplacer par votre lettre de motivation
    ...
    Enfin, je vous priais de bien vouloir m'indiquer quelle proc\'{e}dure \ProcurantId{} doit effectuer afin d'obtenir une version \'{a} jour, en terme de pr\'{e}nom et de civilit\'{e}, de ses dipl\^{o}mes.
