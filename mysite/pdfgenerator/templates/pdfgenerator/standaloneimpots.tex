...
\newcommand{\ProcurantId}{ {{- form.cleaned_data["firstname"] -}} {} \textsc{ {{- form.cleaned_data["lastname"] -}} }}

% Mettre ici la suite des pr\'{e}noms de la personne faisant la procuration
% et entre les {} le nom de famille
\newcommand{\ProcurantFullId}{ {{- form.cleaned_data["listofname"] -}} {} \textsc{ {{- form.cleaned_data["lastname"] -}} } }

% Mettre ici le num\'{e}ro de t\'{e}l\'{e}phone de la personnne faisant la
% procuration
\newcommand{\ProcurantTel}{ {{- form.cleaned_data["telephone"] -}} }

% Mettre ici le num\'{e}ro, le type de voie et le nom de la voie
% de la personne faisant la procuration
\newcommand{\ProcurantAddresseRue}{ {{- form.cleaned_data["address1"] -}} }

% Mettre ici le code postal (les 2 premiers chiffres avant le ~)
% et entre {} le nom de la ville
\newcommand{\ProcurantAddresseVille}{ {{- form.cleaned_data["address2"] -}} }
...
% famille
\newcommand{\ProcurantOldId}{ {{- form.cleaned_data["deadname"] -}} {} \textsc{ {{- form.cleaned_data["lastname"] -}} }}
...
% 0 = femme trans
% 1 = homme trans
\newcommand{\ProcurantGender}{ {{- form.cleaned_data["gender"] -}} } % 0 = femme, 1 = homme

% Mettre ici le nom de l'\'{e}cole/universit\'{e}/autre \`{a} laquelle la demande
% de rectification et d'information est demand\'{e}e
%\newcommand{\ProcurantEcole}{ {{- form.cleaned_data["ecole"] -}} }

\newcommand{\ProcurantImpots}{ {{- form.cleaned_data["impots"] -}} }
\newcommand{\ProcurantFiscal}{ {{- form.cleaned_data["fiscal"] -}} }
...
%-----------------------------------------------%
\begin{letter}{\`{A} l'attention du Service des Impôts des Particuliers de \ProcurantImpots}
...
%-% \`{À} remplacer par votre lettre de motivation
    Je suis \ProcurantFullId et j'ai r\'{e}cemment obtenu mon changement de pr\'{e}nom à l'\'{E}tat-Civil et le souhaite effectuer les d\'{e}marches de changement de pr\'{e}nom et de civilit\'{e} dans les registres du Service des Impôts des Particuliers de \ProcurantImpots.

    \medskip

    Je suis \if\ProcurantGender0 connue \else connu \fi de vos services sous le nom de \ProcurantOldId et j'ai le numéro fiscal \ProcurantFiscal.
    ...
    De plus, je vous demande de bien vouloir changer ma civilit\'{e} de \if\ProcurantGender0 \og Monsieur \fg{} à \og Madame \fg{} \else \og Madame \fg{} à \og Monsieur \fg{} \fi dans vos registres, et ce pr\'{e}alablement à toute d\'{e}cision de changement de mention de sexe à l'\'{E}tat-Civil, puisque je suis une personne transgenre.
